...
module.exports = function (logger, app, spinalAPIMiddleware) {
  ...
  */
    app.get("/api/v1/room/:id/event_list", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            var nodes = [];
            ...
            if (room.getType().get() === "geographicRoom") {
                var listEvents = yield spinal_env_viewer_task_service_1.SpinalEventService.getEvents(room.getId().get());
